...
public class QuestaoResource {
	...
	@RequestMapping(value="/questionario/{questionario_id}", method=RequestMethod.GET)
	public ResponseEntity<List<QuestaoDTO>> listarQuestoesPorQuestionarioId(@PathVariable Long questionario_id) {
		List<Questao> list = questaoService.listarQuestoesPorQuestionarioId(questionario_id);
